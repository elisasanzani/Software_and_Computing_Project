...
The [Mu2e experiment](https://arxiv.org/pdf/1901.11099.pdf) is being built at Fermilab and it will search for Charged Lepton Flavour Violation (CLFV) via the conversion process:  &mu;<sup>-</sup> + Al(27,13) &rarr; e<sup>-</sup> + Al(27,13). Mu2e will improve the current sensitivity on the ratio between the conversion and capture events rates by four orders of magnitude, reaching a sensitivity of 8x10<sup>-17</sup> at 90% CL. <br>
...
These are data from a full simulation of the Mu2e calorimeter which can probe the high-energy region of the RMC spectrum. <br>
Beam background is too high at low-energy and low-radius of the calorimeter disk, so a preliminary cut has been applied to the data, requiring: E > 50MeV and R > 480 mm.<br>
...
Looking at the energy histogram, the end-point region of the RMC spectrum (&sim;91 MeV) is free from cosmic rays.
<br>
<figure>
    <p align="center">
...
[XGBoost](https://xgboost.readthedocs.io/en/stable/python/python_intro.html) is also implemented.
